...
model.fit(
    mnist.train.data["images"][:5000], sparse_to_distribution(mnist.train.data["labels"][:5000]),
    batch_size=args.batch_size, epochs=args.epochs,
    validation_data=(mnist.dev.data["images"], sparse_to_distribution(mnist.dev.data["labels"])),
    callbacks=[tb_callback],
)

test_logs = model.evaluate(mnist.test.data["images"], sparse_to_distribution(mnist.test.data["labels"]), batch_size=args.batch_size)
