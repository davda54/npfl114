...
parser.add_argument("--system", default='speech_recognition_dev.txt', type=str, help="Path to system output.")
parser.add_argument("--gold", default='timit_mfcc_dev_gold.txt', type=str, help="Path to gold data.")
